...
class OperationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create operation" do
    assert_difference('Operation.count') do
      post operations_url, params: { operation: { date: @operation.date, montantsort: @operation.montantsort, motif: @operation.motif } }
    end
  ...
  test "should update operation" do
    patch operation_url(@operation), params: { operation: { date: @operation.date, montantsort: @operation.montantsort, motif: @operation.motif } }
